...
const INSTAGRAM_URL =
  import.meta.env.VITE_INSTAGRAM_URL || 'https://www.instagram.com/optiwiseinfrastructure?stkn=MTY3aHFmeWFwcnFmeQ==';
...
const Footer = () => {
  ...
  />
      ...
      <div>
  <span className="coord-tag footer__heading">Follow & Connect</span>
